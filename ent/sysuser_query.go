...
func (suq *SysUserQuery) QueryCreateBy() *SysUserQuery {
	query := (&SysUserClient{config: suq.config}).Query()
...
func (suq *SysUserQuery) QueryUpdateBy() *SysUserQuery {
	query := (&SysUserClient{config: suq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := suq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (suq *SysUserQuery) QueryDeleteBy() *SysUserQuery {
	query := (&SysUserClient{config: suq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := suq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (suq *SysUserQuery) Clone() *SysUserQuery {
	...
	return &SysUserQuery{
		...
		withCreateBy: suq.withCreateBy.Clone(),
		withUpdateBy: suq.withUpdateBy.Clone(),
		withDeleteBy: suq.withDeleteBy.Clone(),
...
func (suq *SysUserQuery) WithCreateBy(opts ...func(*SysUserQuery)) *SysUserQuery {
	query := (&SysUserClient{config: suq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	suq.withCreateBy = query
	return suq
}
...
func (suq *SysUserQuery) WithUpdateBy(opts ...func(*SysUserQuery)) *SysUserQuery {
	query := (&SysUserClient{config: suq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	suq.withUpdateBy = query
	return suq
}
...
func (suq *SysUserQuery) WithDeleteBy(opts ...func(*SysUserQuery)) *SysUserQuery {
	query := (&SysUserClient{config: suq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	suq.withDeleteBy = query
	return suq
}
...
func (suq *SysUserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SysUser, error) {
	var (
		...
		_spec       = suq.querySpec()
		loadedTypes = [3]bool{
			suq.withCreateBy != nil,
			suq.withUpdateBy != nil,
			suq.withDeleteBy != nil,
		}
	)
	...
	if query := suq.withCreateBy; query != nil {
		if err := suq.loadCreateBy(ctx, query, nodes, nil,
			func(n *SysUser, e *SysUser) { n.Edges.CreateBy = e }); err != nil {
			return nil, err
		}
	}
	if query := suq.withUpdateBy; query != nil {
		if err := suq.loadUpdateBy(ctx, query, nodes, nil,
			func(n *SysUser, e *SysUser) { n.Edges.UpdateBy = e }); err != nil {
			return nil, err
		}
	}
	if query := suq.withDeleteBy; query != nil {
		if err := suq.loadDeleteBy(ctx, query, nodes, nil,
			func(n *SysUser, e *SysUser) { n.Edges.DeleteBy = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (suq *SysUserQuery) loadCreateBy(ctx context.Context, query *SysUserQuery, nodes []*SysUser, init func(*SysUser), assign func(*SysUser, *SysUser)) error {
...
func (suq *SysUserQuery) loadUpdateBy(ctx context.Context, query *SysUserQuery, nodes []*SysUser, init func(*SysUser), assign func(*SysUser, *SysUser)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*SysUser)
	for i := range nodes {
		fk := nodes[i].Updater
...
func (suq *SysUserQuery) loadDeleteBy(ctx context.Context, query *SysUserQuery, nodes []*SysUser, init func(*SysUser), assign func(*SysUser, *SysUser)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*SysUser)
	for i := range nodes {
		fk := nodes[i].Deleter
...
func (suq *SysUserQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := suq.ctx.Fields; len(fields) > 0 {
		...
		if suq.withCreateBy != nil {
			_spec.Node.AddColumnOnce(sysuser.FieldCreator)
		}
		if suq.withUpdateBy != nil {
			_spec.Node.AddColumnOnce(sysuser.FieldUpdater)
		}
		if suq.withDeleteBy != nil {
			_spec.Node.AddColumnOnce(sysuser.FieldDeleter)
		}
	}
