...
func (srq *SysRoleQuery) QueryCreateBy() *SysUserQuery {
...
func (srq *SysRoleQuery) QueryUpdateBy() *SysUserQuery {
	query := (&SysUserClient{config: srq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := srq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (srq *SysRoleQuery) QueryDeleteBy() *SysUserQuery {
	query := (&SysUserClient{config: srq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := srq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (srq *SysRoleQuery) Clone() *SysRoleQuery {
	...
	return &SysRoleQuery{
		...
		withCreateBy: srq.withCreateBy.Clone(),
		withUpdateBy: srq.withUpdateBy.Clone(),
		withDeleteBy: srq.withDeleteBy.Clone(),
...
func (srq *SysRoleQuery) WithCreateBy(opts ...func(*SysUserQuery)) *SysRoleQuery {
	query := (&SysUserClient{config: srq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	srq.withCreateBy = query
	return srq
}
...
func (srq *SysRoleQuery) WithUpdateBy(opts ...func(*SysUserQuery)) *SysRoleQuery {
	query := (&SysUserClient{config: srq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	srq.withUpdateBy = query
	return srq
}
...
func (srq *SysRoleQuery) WithDeleteBy(opts ...func(*SysUserQuery)) *SysRoleQuery {
	query := (&SysUserClient{config: srq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	srq.withDeleteBy = query
	return srq
}
...
func (srq *SysRoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SysRole, error) {
	var (
		...
		_spec       = srq.querySpec()
		loadedTypes = [3]bool{
			srq.withCreateBy != nil,
			srq.withUpdateBy != nil,
			srq.withDeleteBy != nil,
		}
	)
	...
	if query := srq.withCreateBy; query != nil {
		if err := srq.loadCreateBy(ctx, query, nodes, nil,
			func(n *SysRole, e *SysUser) { n.Edges.CreateBy = e }); err != nil {
			return nil, err
		}
	}
	if query := srq.withUpdateBy; query != nil {
		if err := srq.loadUpdateBy(ctx, query, nodes, nil,
			func(n *SysRole, e *SysUser) { n.Edges.UpdateBy = e }); err != nil {
			return nil, err
		}
	}
	if query := srq.withDeleteBy; query != nil {
		if err := srq.loadDeleteBy(ctx, query, nodes, nil,
			func(n *SysRole, e *SysUser) { n.Edges.DeleteBy = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (srq *SysRoleQuery) loadCreateBy(ctx context.Context, query *SysUserQuery, nodes []*SysRole, init func(*SysRole), assign func(*SysRole, *SysUser)) error {
...
func (srq *SysRoleQuery) loadUpdateBy(ctx context.Context, query *SysUserQuery, nodes []*SysRole, init func(*SysRole), assign func(*SysRole, *SysUser)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*SysRole)
	for i := range nodes {
		fk := nodes[i].Updater
...
func (srq *SysRoleQuery) loadDeleteBy(ctx context.Context, query *SysUserQuery, nodes []*SysRole, init func(*SysRole), assign func(*SysRole, *SysUser)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*SysRole)
	for i := range nodes {
		fk := nodes[i].Deleter
...
func (srq *SysRoleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := srq.ctx.Fields; len(fields) > 0 {
		...
		if srq.withCreateBy != nil {
			_spec.Node.AddColumnOnce(sysrole.FieldCreator)
		}
		if srq.withUpdateBy != nil {
			_spec.Node.AddColumnOnce(sysrole.FieldUpdater)
		}
		if srq.withDeleteBy != nil {
			_spec.Node.AddColumnOnce(sysrole.FieldDeleter)
		}
	}
