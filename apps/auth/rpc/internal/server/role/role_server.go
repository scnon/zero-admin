...
func (s *RoleServer) AssignRoleMenu(ctx context.Context, in *auth.AssignRoleMenuReq) (*auth.AssignRoleMenuResp, error) {
	l := rolelogic.NewAssignRoleMenuLogic(ctx, s.svcCtx)
	return l.AssignRoleMenu(in)
}
