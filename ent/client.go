...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.SysApi.Intercept(interceptors...)
...
// QueryCreateBy queries the create_by edge of a SysApi.
func (c *SysApiClient) QueryCreateBy(sa *SysApi) *SysUserQuery {
...
// QueryUpdateBy queries the update_by edge of a SysApi.
func (c *SysApiClient) QueryUpdateBy(sa *SysApi) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sa.ID
		step := sqlgraph.NewStep(
...
// QueryDeleteBy queries the delete_by edge of a SysApi.
func (c *SysApiClient) QueryDeleteBy(sa *SysApi) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sa.ID
		step := sqlgraph.NewStep(
...
// QueryCreateBy queries the create_by edge of a SysMenu.
func (c *SysMenuClient) QueryCreateBy(sm *SysMenu) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sm.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, sysmenu.CreateByTable, sysmenu.CreateByColumn),
		)
...
// QueryUpdateBy queries the update_by edge of a SysMenu.
func (c *SysMenuClient) QueryUpdateBy(sm *SysMenu) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sm.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysmenu.Table, sysmenu.FieldID, id),
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, sysmenu.UpdateByTable, sysmenu.UpdateByColumn),
		)
		fromV = sqlgraph.Neighbors(sm.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDeleteBy queries the delete_by edge of a SysMenu.
func (c *SysMenuClient) QueryDeleteBy(sm *SysMenu) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sm.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysmenu.Table, sysmenu.FieldID, id),
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, sysmenu.DeleteByTable, sysmenu.DeleteByColumn),
		)
		fromV = sqlgraph.Neighbors(sm.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryCreateBy queries the create_by edge of a SysRole.
func (c *SysRoleClient) QueryCreateBy(sr *SysRole) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sr.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, sysrole.CreateByTable, sysrole.CreateByColumn),
		)
...
// QueryUpdateBy queries the update_by edge of a SysRole.
func (c *SysRoleClient) QueryUpdateBy(sr *SysRole) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sr.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysrole.Table, sysrole.FieldID, id),
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, sysrole.UpdateByTable, sysrole.UpdateByColumn),
		)
		fromV = sqlgraph.Neighbors(sr.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDeleteBy queries the delete_by edge of a SysRole.
func (c *SysRoleClient) QueryDeleteBy(sr *SysRole) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := sr.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysrole.Table, sysrole.FieldID, id),
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, sysrole.DeleteByTable, sysrole.DeleteByColumn),
		)
		fromV = sqlgraph.Neighbors(sr.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryCreateBy queries the create_by edge of a SysUser.
func (c *SysUserClient) QueryCreateBy(su *SysUser) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := su.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, sysuser.CreateByTable, sysuser.CreateByColumn),
		)
...
// QueryUpdateBy queries the update_by edge of a SysUser.
func (c *SysUserClient) QueryUpdateBy(su *SysUser) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := su.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysuser.Table, sysuser.FieldID, id),
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, sysuser.UpdateByTable, sysuser.UpdateByColumn),
		)
		fromV = sqlgraph.Neighbors(su.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDeleteBy queries the delete_by edge of a SysUser.
func (c *SysUserClient) QueryDeleteBy(su *SysUser) *SysUserQuery {
	query := (&SysUserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := su.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(sysuser.Table, sysuser.FieldID, id),
			sqlgraph.To(sysuser.Table, sysuser.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, sysuser.DeleteByTable, sysuser.DeleteByColumn),
		)
		fromV = sqlgraph.Neighbors(su.driver.Dialect(), step)
		return fromV, nil
	}
...
type (
	hooks struct {
		SysApi, SysMenu, SysRole, SysUser []ent.Hook
	}
	inters struct {
		SysApi, SysMenu, SysRole, SysUser []ent.Interceptor
	}
)
