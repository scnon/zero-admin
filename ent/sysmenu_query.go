...
func (smq *SysMenuQuery) QueryCreateBy() *SysUserQuery {
	query := (&SysUserClient{config: smq.config}).Query()
...
func (smq *SysMenuQuery) QueryUpdateBy() *SysUserQuery {
	query := (&SysUserClient{config: smq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := smq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (smq *SysMenuQuery) QueryDeleteBy() *SysUserQuery {
	query := (&SysUserClient{config: smq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := smq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (smq *SysMenuQuery) Clone() *SysMenuQuery {
	...
	return &SysMenuQuery{
		...
		withCreateBy: smq.withCreateBy.Clone(),
		withUpdateBy: smq.withUpdateBy.Clone(),
		withDeleteBy: smq.withDeleteBy.Clone(),
...
func (smq *SysMenuQuery) WithCreateBy(opts ...func(*SysUserQuery)) *SysMenuQuery {
	query := (&SysUserClient{config: smq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	smq.withCreateBy = query
	return smq
}
...
func (smq *SysMenuQuery) WithUpdateBy(opts ...func(*SysUserQuery)) *SysMenuQuery {
	query := (&SysUserClient{config: smq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	smq.withUpdateBy = query
	return smq
}
...
func (smq *SysMenuQuery) WithDeleteBy(opts ...func(*SysUserQuery)) *SysMenuQuery {
	query := (&SysUserClient{config: smq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	smq.withDeleteBy = query
	return smq
}
...
func (smq *SysMenuQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SysMenu, error) {
	var (
		...
		_spec       = smq.querySpec()
		loadedTypes = [3]bool{
			smq.withCreateBy != nil,
			smq.withUpdateBy != nil,
			smq.withDeleteBy != nil,
		}
	)
	...
	if query := smq.withCreateBy; query != nil {
		if err := smq.loadCreateBy(ctx, query, nodes, nil,
			func(n *SysMenu, e *SysUser) { n.Edges.CreateBy = e }); err != nil {
			return nil, err
		}
	}
	if query := smq.withUpdateBy; query != nil {
		if err := smq.loadUpdateBy(ctx, query, nodes, nil,
			func(n *SysMenu, e *SysUser) { n.Edges.UpdateBy = e }); err != nil {
			return nil, err
		}
	}
	if query := smq.withDeleteBy; query != nil {
		if err := smq.loadDeleteBy(ctx, query, nodes, nil,
			func(n *SysMenu, e *SysUser) { n.Edges.DeleteBy = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (smq *SysMenuQuery) loadCreateBy(ctx context.Context, query *SysUserQuery, nodes []*SysMenu, init func(*SysMenu), assign func(*SysMenu, *SysUser)) error {
...
func (smq *SysMenuQuery) loadUpdateBy(ctx context.Context, query *SysUserQuery, nodes []*SysMenu, init func(*SysMenu), assign func(*SysMenu, *SysUser)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*SysMenu)
	for i := range nodes {
		fk := nodes[i].Updater
...
func (smq *SysMenuQuery) loadDeleteBy(ctx context.Context, query *SysUserQuery, nodes []*SysMenu, init func(*SysMenu), assign func(*SysMenu, *SysUser)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*SysMenu)
	for i := range nodes {
		fk := nodes[i].Deleter
...
func (smq *SysMenuQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := smq.ctx.Fields; len(fields) > 0 {
		...
		if smq.withCreateBy != nil {
			_spec.Node.AddColumnOnce(sysmenu.FieldCreator)
		}
		if smq.withUpdateBy != nil {
			_spec.Node.AddColumnOnce(sysmenu.FieldUpdater)
		}
		if smq.withDeleteBy != nil {
			_spec.Node.AddColumnOnce(sysmenu.FieldDeleter)
		}
	}
