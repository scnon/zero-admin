...
func (m *defaultSysUserModel) Insert(ctx context.Context, data *SysUser) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Username, data.Password, data.Nickname, data.Status, data.Sort, data.Remark, data.Roles, data.TenantId)
	}, sysUserIdKey, sysUserUsernameKey)
	return ret, err
}
...
func (m *defaultSysUserModel) Update(ctx context.Context, newData *SysUser) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Username, newData.Password, newData.Nickname, newData.Status, newData.Sort, newData.Remark, newData.Roles, newData.TenantId, newData.Id)
	}, sysUserIdKey, sysUserUsernameKey)
	return err
}
