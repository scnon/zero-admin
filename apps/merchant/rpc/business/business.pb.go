...
type GetBusinessResp struct {
	...
	Business []*BusinessInfo `protobuf:"bytes,1,rep,name=merchant,proto3" json:"merchant,omitempty"`
}
...
var file_apps_business_rpc_business_proto_goTypes = []interface{}{
	(*BusinessInfo)(nil),       // 0: merchant.BusinessInfo
	(*AddBusinessReq)(nil),     // 1: merchant.AddBusinessReq
	(*DeleteBusinessReq)(nil),  // 2: merchant.DeleteBusinessReq
	(*DeleteBusinessResp)(nil), // 3: merchant.DeleteBusinessResp
	(*GetBusinessReq)(nil),     // 4: merchant.GetBusinessReq
	(*GetBusinessResp)(nil),    // 5: merchant.GetBusinessResp
}
var file_apps_business_rpc_business_proto_depIdxs = []int32{
	0, // 0: merchant.GetBusinessResp.merchant:type_name -> merchant.BusinessInfo
	1, // 1: merchant.Business.AddBusiness:input_type -> merchant.AddBusinessReq
	0, // 2: merchant.Business.UpdateBusiness:input_type -> merchant.BusinessInfo
	2, // 3: merchant.Business.DeleteBusiness:input_type -> merchant.DeleteBusinessReq
	4, // 4: merchant.Business.GetBusiness:input_type -> merchant.GetBusinessReq
	0, // 5: merchant.Business.AddBusiness:output_type -> merchant.BusinessInfo
	0, // 6: merchant.Business.UpdateBusiness:output_type -> merchant.BusinessInfo
	3, // 7: merchant.Business.DeleteBusiness:output_type -> merchant.DeleteBusinessResp
	5, // 8: merchant.Business.GetBusiness:output_type -> merchant.GetBusinessResp
